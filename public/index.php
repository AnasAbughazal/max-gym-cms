...
<?php include("../includes/layout/part_index/header.php");?>
<?php include("../includes/contectDB_index.php");?>
...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="index.html">Max Gym</a>
     ...
     <section class="about section" id="about">
               <div class="container">
                    <div class="row">
                            ...
                            <div class="mt-lg-12 ">
                                <h2 class="mb-4" data-aos="fade-up" data-aos-delay="300">Hello, we are Max Gym</h2>
								<?php	
							   ...
							   if(mysqli_num_rows($result)>0)
								{
									echo "<p data-aos='fade-up' data-aos-delay='400'>".$row['about_text']."</p>";
								}
						...
						if(mysqli_num_rows($result)>0)
                            ...
                            <div class="ml-lg-auto col-lg-3 col-md-6 col-12" data-aos="fade-up" data-aos-delay="700">
                                <div class="team-thumb">
                                    <img src="static/images/team/team-image.jpg" class="img-fluid" alt="Trainer">

                                    <div class="team-info d-flex flex-column">
											
                                        <h5><?php echo $row['name'] ." <br><strong>". $row['training_type']."</strong>";?></h5>
               ...
               <div class="container">
                    <div class="row">
                            ...
                            <div class="col-lg-12 col-12 text-center mb-5">
							 ...
							 <?php
							 $query= "SELECT * FROM `class` WHERE visible_class=1 ";
								$result=mysqli_query($contect,$query);
								if(mysqli_num_rows($result)>0)
									{
									 while ($row = mysqli_fetch_assoc($result)) 
                            ...
                            <div class="col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay="400">
								...
								<div class="class-thumb">
                                    <img src="static/images/class/yoga-class.jpg" class="img-fluid" alt="Class">

                                    <div class="class-info">
                                        <h3 class="mb-1"><?php echo $row['name_class'];?></h3>

                                        <span><strong>Trained by</strong> - <?php echo $row['type_class'];?></span><br/>
                                        <span><strong>Class Time </strong> - <?php echo $row['time_class'];?></span>

                                       <!-- <span class="class-price">$ <?php //echo $row['price'];?></span>-->
